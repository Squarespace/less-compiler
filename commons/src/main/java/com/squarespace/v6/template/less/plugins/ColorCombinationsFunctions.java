...
public class ColorCombinationsFunctions implements Registry<Function> {
  ...
  public static final Function DIFFERENCE = new Function("difference", "cc") {
    ...
    public Node invoke(ExecEnv env, List<Node> args) throws LessException {
      RGBColor c1 = rgb(args.get(0));
      RGBColor c2 = rgb(args.get(1));
      int red = Math.abs(c1.red() - c2.red());
      int green = Math.abs(c1.green() - c2.green());
      int blue = Math.abs(c1.blue() - c2.blue());
      return new RGBColor(red, green, blue);
    }
  };
  ...
  public static final Function EXCLUSION = new Function("exclusion", "cc") {
    ...
    public Node invoke(ExecEnv env, List<Node> args) throws LessException {
      RGBColor c1 = rgb(args.get(0));
      RGBColor c2 = rgb(args.get(1));
      int red = exclusion(c1.red(), c2.red());
      int green = exclusion(c1.green(), c2.green());
      int blue = exclusion(c1.blue(), c2.blue());
      return new RGBColor(red, green, blue);
    }
  };
  
  private static int exclusion(int c1, int c2) {
    return (int)(c1 + c2 * (255 - c1 - c1) / 255.0);
  }
  ...
  public static final Function HARDLIGHT = new Function("hardlight", "cc") {
    ...
    public Node invoke(ExecEnv env, List<Node> args) throws LessException {
      RGBColor c1 = rgb(args.get(0));
      RGBColor c2 = rgb(args.get(1));
      int red = hardlight(c1.red(), c2.red());
      int green = hardlight(c1.green(), c2.green());
      int blue = hardlight(c1.blue(), c2.blue());
      return new RGBColor(red, green, blue);
    }
  };
  
  private static int hardlight(int c1, int c2) {
    if (c2 < 128) {
      return (int)(2 * c2 * c1 / 255.0);
    }
    return (int)(255 - 2 * (255 - c2) * (255 - c1) / 255.0);
  }
  ...
  public static final Function MULTIPLY = new Function("multiply", "cc") {
    ...
    public Node invoke(ExecEnv env, List<Node> args) throws LessException {
      RGBColor c1 = rgb(args.get(0));
      RGBColor c2 = rgb(args.get(1));
      int red = (int)(c1.red() * c2.red() / 255);
      int green = (int)(c1.green() * c2.green() / 255);
      int blue = (int)(c1.blue() * c2.blue() / 255);
      return new RGBColor(red, green, blue);
    }
  };
  ...
  public static final Function NEGATION = new Function("negation", "cc") {
    ...
    public Node invoke(ExecEnv env, List<Node> args) throws LessException {
      RGBColor c1 = rgb(args.get(0));
      RGBColor c2 = rgb(args.get(1));
      int red = negation(c1.red(), c2.red());
      int green = negation(c1.green(), c2.green());
      int blue = negation(c1.blue(), c2.blue());
      return new RGBColor(red, green, blue);
    }
  };

  private static final int negation(int c1, int c2) {
  ...
  public static final Function OVERLAY = new Function("overlay", "cc") {
    ...
    public Node invoke(ExecEnv env, List<Node> args) throws LessException {
      RGBColor c1 = rgb(args.get(0));
      RGBColor c2 = rgb(args.get(1));
      int red = overlay(c1.red(), c2.red());
      int green = overlay(c1.green(), c2.green());
      int blue = overlay(c1.blue(), c2.blue());
      return new RGBColor(red, green, blue);
    }

  };

  private static int overlay(int c1, int c2) {
    if (c1 < 128) {
      return 2 * c1 * c2 / 255;
    }
  ...
  public static final Function SCREEN = new Function("screen", "cc") {
    ...
    public Node invoke(ExecEnv env, List<Node> args) throws LessException {
      RGBColor c1 = rgb(args.get(0));
      RGBColor c2 = rgb(args.get(1));
      int red = screen(c1.red(), c2.red());
      int green = screen(c1.green(), c2.green());
      int blue = screen(c1.blue(), c2.blue());
      return new RGBColor(red, green, blue);
    }
  };
  
  private static int screen(int c1, int c2) {
